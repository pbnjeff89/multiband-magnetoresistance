function a = generateTwoBandCoefficients(a0,RxxH,RxxR,RxyH,RxyR,RxxHrange,RxyHrange)
...
f = @(a)twoBand(a,Hxx,Rxx,Hxy,Rxy);

a = lsqnonlin(f,a0,[0;-1e9;0;-1e9],[1e9;1e9;1e9;1e9], options);